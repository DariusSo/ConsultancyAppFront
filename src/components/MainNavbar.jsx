...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-[#232529] to-[#2E2F33] text-gray-200 shadow-md relative">
      <div className="container mx-auto px-4 flex items-center justify-between h-16 relative">
        <div className="hidden md:flex flex-1 justify-center space-x-8 items-center">
          <div className="relative group">
            ...
            <div className="absolute left-0 mt-2 w-40 bg-[#34373C] rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
              <ul className="py-2">
                <li>
                  <Link
      ...
      <div
        className={`${
          isMobileMenuOpen ? "h-auto py-4" : "h-0"
        } overflow-hidden md:hidden bg-[#34373C] text-gray-200 transition-all duration-300 z-40 relative`}
      >
        <ul className={`${isMobileMenuOpen ? "space-y-2 px-4" : "hidden"}`}>
          ...
          <li>
            ...
            <button
              className="flex items-center space-x-2 hover:text-green-500 w-full"
