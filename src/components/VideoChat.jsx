...
const VideoChat = forwardRef((props, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    connect: () => connectToWebRTC(stompClientRef, roomUuid, peerConnectionRef, iceCandidateQueue, peerId, roomUuid),
    startCall: () => startCall(peerConnectionRef, stompClientRef, receivedStreamRef, peerId, localVideoRef, roomUuid, remoteVideoRef),
    disconnect: () => disconnectCall(peerConnectionRef, stompClientRef, localVideoRef, remoteVideoRef),
  }));
